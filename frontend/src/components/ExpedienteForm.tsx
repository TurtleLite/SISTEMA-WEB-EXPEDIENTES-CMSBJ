...
export function ExpedienteForm({ listId, role, medicoName, onClose, onSaved, editingRecord, expectedUpdatedAt }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-[#0F172A]/30 backdrop-blur-sm flex flex-col z-50">
      <div className="bg-[#F7F8FA] w-full h-full flex flex-col overflow-y-auto overflow-x-hidden">
