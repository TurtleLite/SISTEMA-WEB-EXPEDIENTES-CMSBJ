  ...
  return (
    <div className="fixed inset-0 bg-[#0F172A]/30 backdrop-blur-sm flex items-center justify-center z-50 overflow-hidden p-4">
      <div className="bg-[#F7F8FA] w-full h-full max-h-[94vh] flex flex-col overflow-visible max-w-full rounded-xl shadow-xl">
        ...
        <div className="flex-1 min-h-0 h-0 px-6 md:px-8 py-6 bg-[#F5F7FA] flex justify-center overflow-hidden"><div className="w-full flex flex-col gap-2 overflow-hidden pb-2">
          {sections.map((section, sIdx) => {
            ...
            return (
              <Fragment key={section.title}>
                <div id={`form-section-${sIdx}`} className={`${isOpen ? 'block' : 'hidden'} bg-white border border-[#D5DBE3] rounded-lg overflow-hidden flex flex-col ${section.title === 'Datos Personales' ? 'max-h-[72vh] mb-2' : 'max-h-[60vh] mb-2'}`}>
                  <div
